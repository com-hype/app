...
const defaultActionsProp = {
  yup: {
    show: true,
    icon: require('../../../../assets/img/icons/like.png'),
    type: 'like',
  },
  nope: {
    show: true,
    icon: require('../../../../assets/img/icons/dislike.png'),
    type: 'dislike',
  },
};
...
export default class SwipeCards extends Component {
  ...
  _goToNextCard() {
    ...
    this.props.currentCard(currentIndex[this.guid]);
    ...
    return (
      <Animated.View
        ...
        {props.view ? (
          ...
          <Defaults.ActionView icon={props.icon} type={props.type} />
        )}
      </Animated.View>
    );
  }
